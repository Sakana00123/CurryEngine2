...
namespace Editor.GameProject
{
    ...
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\CurryEditor\";
        ...
        private static void ReadProjectData()
        {
            if ((File.Exists(_projectDataPath)))
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Curry\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Curry\Screenshot.png");
